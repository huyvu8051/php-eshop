	        			...
	        			<div class="box-body">
	        				<table class="table table-bordered" id="example1">
	        					...
	        					<?php
	        						...
	        						try{
	        							$stmt = $conn->prepare("SELECT * FROM orders WHERE user_id=:user_id ORDER BY create_date DESC");
	        							...
	        							foreach($stmt as $row){
	        								echo "
	        									<tr>
	        										...
	        										<td>".$row['status']."</td>
	        										<td>".$row['address']."</td>
	        										<td><button class='btn btn-sm btn-flat btn-info transact' data-id='".$row['id']."' onclick='getOrderDetails(".$row['id'].")'><i class='fa fa-search'></i> View</button></td>
	        									</tr>
	        								";
	        							}
